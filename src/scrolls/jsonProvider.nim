...
type JsonProvider* = ref object of ConfigurationProvider
...
proc parseValue(value: JsonNode, kind: ConfigValueKind): ConfigValue =
  ...
  case kind
  of String:
    ConfigValue(kind: String, sval: value.str)
  of Bool:
    ConfigValue(kind: Bool, bval: value.bval)
  of Int:
    ConfigValue(kind: Int, ival: value.num)
  of Double:
    ConfigValue(kind: Double, dval: value.fnum)
  of StringList:
...
method value*(
    provider: JsonProvider, key: string, kind: ConfigValueKind
): Option[ConfigValue] =
